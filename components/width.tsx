...
export const getWidthnHeight = (
  widthPercent: undefined | number = 0,
  heightPercent: undefined | number = 0
) => {
  ...
  if (typeof widthPercent === "number" && typeof heightPercent === "number") {
    ...
    typeof heightPercent === "undefined"
  ) {
    widthValue = { width: (width * widthPercent) / 100 };
    ////console.log('widthPassed: ', widthValue);
    return widthValue;
  } else if (
    typeof widthPercent === "undefined" &&
